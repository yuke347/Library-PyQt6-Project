from PyQt6.QtWidgets import QApplication, QLabel,QMainWindow,QVBoxLayout,QWidget,QPushButton,QLineEdit,QComboBox,QListWidget
...
class MainWindow(QWidget):
    ...
    def signInPrompt(self):
        ...
        self.inputLine5.setPlaceholderText("Day of birth")
    ...
    def adminPage(self):
        ...
        self.button4.setText("Set book amount")
        self.button2.setText("Remove a book")
        self.button3.setText("Log out")
        ...
        self.set_layout(self.label2,self.button1,self.button4,self.button2,self.button3)
        self.setLayout(self.layout)
